      ...
      <div style={styles.box}>
        ...
        <div className="d-flex flex-row justify-content-center">
          <div style={!isGas ? styles.atom1 : styles.atom2} onClick={() => setIsGas(false)}>
            ...
            <div className="mt-2 fw-semibold text-center">No Gas Required</div>
            {width > 450 && <div className="fw-semibold" />}
          </div>
          <div style={isGas ? styles.atom1 : styles.atom2} onClick={() => setIsGas(true)}>
            ...
            <div className="mt-2 fw-semibold text-center">Gas Fee Required</div>
            {width > 450 && <div className="fw-semibold" />}
          </div>
        </div>
      </div>
