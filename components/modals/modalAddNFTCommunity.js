  ...
  return (
    ...
    >
      ...
      <div className="w-100 d-flex flex-column align-items-start">
        ...
        <div className="w-100 d-flex flex-row justify-content-around color-b f-16">
        ...
        {tab === 1 && <>
          <div className="w-100 d-flex flex-row">
            <input
              className="w-100 form-control f-16"
                ...
                return (
                  ...
                  >
                    <div className='width-50 height-50 d-flex align-items-center justify-content-center'>
                      {!isVideo && <img
                        src={UtilService.ConvertImg(image)}
                        alt=""
                        style={{ width: 'auto', maxHeight: 40, maxWidth: 40 }}
                      />}
                      {isVideo && <video src={UtilService.ConvertImg(image)} style={{ maxHeight: '100%', maxWidth: '100%' }} ></video>}
                    </div>
