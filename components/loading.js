...
export function TinyLoading() {
  return (
    <div className="d-flex align-items-center justify-content-center" style={{ width: 140 }}>
...
export function SmallLoading(props) {
  return (
    <div className="w-100 mt-30 d-flex align-items-center justify-content-center">
