    ...
    <div className="col-lg-6 m-auto">
...

      {
        [...addedNFT, ...addedGlobalNFT].map((item, index) => {
          ...
          image = UtilService.ConvertImg(metadata.image);

          return <div className="my-3 position-relative" style={{ border: '2px solid #8364E2', borderRadius: '10px' }}>
            <div key={index} className="py-3 px-4 d-flex position-relative align-items-center justify-content-between">
              ...
              <span
                className='icon_close_alt fs-32 position-absolute cursor-pointer'
            ...
            {index !== [...addedNFT, ...addedGlobalNFT].length - 1 &&
              <div className='d-flex mb-3 mt-3 position-absolute cursor-pointer' style={{ right: -150, bottom: -45 }}>
                <div
