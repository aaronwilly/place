...
function Step2({ baseFile }) {
  ...
  const onUploadThumbnail = useCallback(async () => {
    ...
    dispatch(onUpdateCreator({ thumbnail: 'ipfs://' + result.path }))
      ...
      <div className="d-flex">
        <div className="my-3 w-100 my-4 d-flex" style={{ minHeight: '150px', border: '1px dashed #8364E2' }}>
          ...
          <div className="d-flex flex-column m-auto">
            <div className='m-5 text-center color-7'>How do you create an NFT? Basically <span className='color-b fw-semibold'> you can create anything in the support file formats under 100mb JPG, PNG, GIF, SVG, MP4, WEBM, MP3, WAV, OGG, GLB, GLTF.</span></div>
