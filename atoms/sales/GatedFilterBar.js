...
const GatedFilterBar = ({ search, setGateSearch }) => {
  ...
  return (
    <div>
      <div className='d-flex flex-row flex-wrap align-items-center' style={{ marginTop: 20, marginLeft: 20 }}>
        ...
        {isClear && <div className='ml-4 text-primary cursor-pointer -mt-10' onClick={onClearSearch}>Clear All</div>}
      </div>
    </div>
  );
}
