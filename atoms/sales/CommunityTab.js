...
const CommunityTab = ({ filteredCommunities, isActive, setIsActive, allLikesData = [] }) => {

  const totalCounts = filteredCommunities.length;
  const favData = filteredCommunities.filter(item => allLikesData.includes(item.id))
