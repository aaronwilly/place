      ...
      <div className="row align-items-center">
        ...
        <div className="col-md-7">
          ...
          <Reveal className='onStep' keyframes={fadeInUp} delay={600} duration={600} triggerOnce>
            <p className=" lead">
            Klik provides a Web2 experience that helps ease your customers
...
function ATOM({ item }) {
  ...
  return (
    <div className='f-1 d-center justify-content-start' style={{ padding: '0 18px' }}>
      <img src={icon} alt='icon'/>
      <div className='color-sky text-center mt-20 fw-semibold' style={{ fontSize: 20 }}>{title}</div>
