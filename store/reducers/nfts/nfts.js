import { GET_NFT721_DATA, UPDATE_CREATOR_NFT, EMPTY_CREATOR_NFT, UPDATE_GATED_NFT, EMPTY_GATED_NFT, UPDATE_IS_LOADING, GET_LAZY_COLLECTION_DATA, UPDATE_SEARCH, EMPTY_SEARCH, UPDATE_FILTER } from "../../actions/actionTypes";
  ...
  switch (action.type) {
    case GET_NFT721_DATA:
      const hexIdData = action.payload.data.map(x => {
        const hextokenId = UtilService.checkHexa(x.token_id) ? x.token_id : '0x' + bigInt(x.token_id).toString(16);
