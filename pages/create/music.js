...
import { createMusic, getMusicChannels } from '../../common/api/authApi';
...
const CreateMusicPage = () => {
  ...
  const [baseFileThumbnail, setBaseFileThumbnail] = useState('')
  ...
  const handleChannel = e => setChannel(e.value)
      ...
      <section>
        <div className="row">
          <div className="col-lg-7 offset-lg-1 mb-5">
            <form id="form-create-item" className="form-border" action="#">
              <div className="field-set">
                ...
                <div className="d-row ">
                  {!isLoading ?
                    <div className="width-100 offer-btn buy-btn" onClick={onUploadMusic}>Save</div>
                    :
                    <TinyLoading />
                  }
          ...
          <div className="col-lg-4 col-sm-12 col-xs-12">
            <div className="w-100">
              <div className="my-3 mx-auto d-flex flex-column align-items-center justify-content-center">
                ...
                <br />
                <div className="width-300 color-b text-center overflow-hidden">{file && file.name}</div>
              </div>
            </div>
                ...
                <div className="my-3 w-100 my-4 d-flex" style={{ minHeight: '150px', border: '1px dashed #8364E2', maxWidth: 600 }}>
                  <div className="m-auto d-flex flex-column">
                    <div className='m-3 text-center color-7'>
                      ...
                      <span className='fw-semibold color-b'> you can create anything in the support file formats under JPG, JPEG, BMP...</span>
                    </div>
            ...
            <div className='d-flex align-items-center justify-content-center'>
              {baseFileThumbnail && <picture><img src={baseFileThumbnail} alt='' className='width-300' /></picture>}
            </div>
