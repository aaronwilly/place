...
import { createBrand, getBrands } from '../../common/api/authApi';
...
const CreateBrandPage = () => {
  ...
  return (
    <LayoutPage container congrat={isCongrat}>
      <section>
        <div className='row'>
          ...
          <div className='col-lg-3 col-sm-6 col-xs-12'>
            ...
            <div className='border-0 d-create-file' style={{ marginTop: -46 }}>
              <div className='browse'>
                <picture>
                  <img src={baseFile1 || file1 || DEMO_AVATAR} alt='avatar' id='get_file' className='mt-0 profile-avatar' />
                </picture>
                <br/>
                <input multiple type='file' id='upload_file' className='cursor-pointer' ref={btnRef1} onChange={onChangeFile1} />
              </div>
            ...
            <div className='border-0 d-create-file' style={{ marginTop: -46 }}>
              ...
              <div className='browse position-relative'>
                <div id='get_file'>
                  {(baseFile2 || file2) &&
                    <picture><img src={baseFile2 || file2} alt='avatar' id='get_file' className='profile-banner' /></picture>
                  }
                  {!(baseFile2 || file2) &&
                    <div
                  ...
                  <br/>
                  <input type='file' id='upload_file' className='cursor-pointer' ref={btnRef2} onChange={onChangeFile2} />
                </div>
              </div>
      ...
      {isAuthenticated && <h3 className='color-b text-center'>My Brands</h3>}
